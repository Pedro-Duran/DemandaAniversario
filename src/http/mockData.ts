// mockData.ts
import type IMissoes from "@/interfaces/IMissoes";

export const missoesMock: IMissoes[] = [
  {
  ...
  {
    "nome": "Indique um negócio",
    "descricao": "Recomende os serviços da nossa empresa para outra empresa ou empreendedor. Se o negócio indicado se tornar um cliente, você receberá bazicash como agradecimento pela sua indicação bem-sucedida.",
 
  },
  {
    "nome": "Complete os combos de camisas",
    "descricao": "Adquira ou compre combos específicos de camisas da nossa coleção, conforme indicado. Ao completar cada conjunto, você será recompensado com bazicash como incentivo para expandir sua coleção de roupas básicas."},
    
  {
    "nome": "Poste sobre a Bázico no Instagram",
